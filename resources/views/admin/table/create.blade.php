...
<h1 class="flex mb-5 items-center text-3xl font-extrabold dark:text-white">ADD TABLE</h1>
<form method="POST" action="{{ route('table.store') }}">
  ...
  <div class="mb-6">
    ...
    <input type="text" value="{{ \Illuminate\Support\Str::random(4) }}" readonly id="code" name="code" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="Enter the table number">
      @error('code')
  ...
  <button type="submit"  class="mb-px text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Add Table</button>
